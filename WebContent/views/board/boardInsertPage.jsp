	...
	<script type="text/javascript">
		function checkValue(){
			...
			if(!title){
				...
				alert("Must upload thumbnail picture.")
				return false;
			} 
				...
				<div class="col-lg-12 text-center">
					<div class="breadcrumb__text">
						...
						<div class="breadcrumb__option">
							<a href="#"><i class="fa fa-home"></i> Home</a> <span>Community</span>
						</div>
					</div>
				</div>
			</div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
          ...
          <input type="hidden" name="writer" value="<%= loginUser.getUserNo() %>">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="title" placeholder="Add Title. 50 Characters"  maxlength="50" required>
              </div>                            
                                        
                                         
              <div class="form-group">
                  
                  <textarea rows="15" cols="150" name="content" class="form-control" id="message" placeholder="Add contents. 2000 Characters" maxlength="2000" required></textarea>                                 
              </div>
              
              
              <div class="text-center">
              <label class="title">Thumb nail Image</label>
              <div>
              ...
              <button type="submit" class="site-btn" onclick="checkValue()">Submit</button>
       		  <button type="reset" id="removefile" class="site-btn">Reset</button>
              <button type="history" class="site-btn" onclick="goBack();">Back to List</button>
              </div>
