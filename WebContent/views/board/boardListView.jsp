<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import = "java.util.ArrayList, semiProject.com.kh.board.model.vo.PageInfo,
    semiProject.com.kh.board.model.vo.Board,
...
<section class="faq bg-color">
      <div class="container">
        <div class="faq-title">
          <h2>Notice</h2>
          <p>This is the lists of Notice</p>
        </div>
...
<!-- =================공지사항 end =============== -->
    ...
    <section class="blog-section spad">
		...
		<div class="blog__pagination" >
          ...
          <br><br><br>          
           <% if(loginUser != null){ %>
			<button  type="submit" class="site-btn" onclick="location.href='enroll.bo'">Write</button>
		 <% }else {%>         
                    
			<button type="submit" class="site-btn" onclick="pop();">Write</button>
			 ...
			 <div class="col-lg-4">
                <div class="blog__sidebar">
                        ...
                        <div class="blog__sidebar__recent">
                            <h5>Best 5 </h5><div id="thumbList"></div> 
                        </div><!-- 인기 글 뿌려 줄 장소  -->
                 </div>
             </div>
	...
	$(function(){
		...
		//from main list >>> click the image
		...
		// 별 클릭때마다 조회 수 올리기
	<%-- 	$(".fa-stars").click(function(){
				var bno = $(this).parent().ind;
				console.log("bno", bno)
				//location.href="<%=contextPath%>/detail.bo?bno="+bno;
			}) --%>
	})
