                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="<%=contextPath %>/views/plan/planSelect.jsp">Planner</a>
                                ...
                                <li><a href="<%=request.getContextPath() %>/list.bo">Community</a></li>
                                
                                <%if(loginUser == null){%>  
                                <li><a href="<%=contextPath %>/views/member/login.jsp" onclick="goLogin();">Login</a></li>
                                <li><a href="<%=contextPath %>/views/member/signUp.jsp" onclick="enrollPage();">Sing up</a></li>
                                 <%}else if(loginUser.getUserId().equals("admin")) { %>
                                <li><a href="<%=contextPath %>/adminPage.ad">Manager page</a></li>
                               	<li><a href="<%=contextPath %>/logout.me">Log out</a></li>                                
                                 <%}
                                else { %>
	                                <li><a href = "<%=request.getContextPath() %>/mypage.me">My page</a></li>
